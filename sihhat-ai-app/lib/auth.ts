...
// Diqqat: bu funksiya backend'da "/api/auth/profile/" yo'nalishini talab
// qiladi. Bu repo faqat mobil ilova kodini o'z ichiga oladi — backend
// (127.0.0.1:8080) alohida loyiha, shu route'ni backend tomonda ham
// qo'shish kerak bo'ladi, aks holda saqlash muvaffaqiyatsiz tugaydi.
export async function updateProfile(params: {
  ...
  const json = await apiPost('/profile/', body);
  if (json.error) return { error: json.error };

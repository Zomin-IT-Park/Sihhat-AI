...
import {
  Plus, Image as LucideImage, FileText, X, Send, Sparkle, MapPin, Phone, AlertTriangle, User,
  ArrowLeft, Settings, Bot, MessageSquarePlus, Trash2, History,
} from 'lucide-react-native';
import { sendChatMessage, type SanatoriumItem } from '../../lib/chat';
import { searchSanatoriumsByName, type SanatoriumRecord } from '../../lib/sanatoriums';
            ...
            if (item.registryResults) {
              return (
                <View style={{ paddingHorizontal: 16, marginBottom: 10 }}>
                  {item.registryResults.map((s: SanatoriumRecord) => (
                    <View key={s.id} style={{

...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 28, fontWeight: '700', color: '#1C1C1E', marginBottom: 4 },
  ...
  cardContent: { flex: 1 },
  cardTitle: { fontSize: 14, color: '#8E8E93', marginBottom: 4 },
  valueRow: { flexDirection: 'row', alignItems: 'baseline', gap: 4 },
  cardValue: { fontSize: 28, fontWeight: '700', color: '#1C1C1E' },
  cardUnit: { fontSize: 14, color: '#8E8E93' },
  tipCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, marginTop: 8 },
  tipTitle: { fontSize: 16, fontWeight: '600', color: '#1C1C1E', marginBottom: 8 },
  tipText: { fontSize: 14, color: '#3A3A3C', lineHeight: 20 },
});

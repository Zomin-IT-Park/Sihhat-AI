...
export default function LoginScreen() {
  ...
  function showErrorToast(msg: string) {
    ...
    // Keyingi tick da ko'rsatish — agar avvalgisi hali ko'rinsa ham qayta trigger bo'ladi
  ...
  return (
    ...
    >
      {/* iOS uslubidagi xato xabari — tepadan tushadi, 3 sekundan so'ng yo'qoladi */}
      <Toast

...
function validateUsername(u: string): string | null {
  ...
  if (!/^[a-zA-Z0-9_]+$/.test(u))
    return 'Faqat harflar, raqamlar va _ ishlatish mumkin';
  return null;
}
...
export default function SignUpScreen() {
  ...
  return (
    ...
    >
      {/* iOS uslubidagi toast — tepadan tushadi */}
      <Toast
      ...
      >
        ...
        <View style={styles.form}>
          ...
          <View>
            ...
            />
            {showPasswordError && (
              <Text style={styles.errorText}>⚠ Parollar bir-biriga mos emas</Text>
            )}
            {showPasswordOk && (
              <Text style={styles.successText}>✓ Parollar mos keldi</Text>
            )}
          </View>
        </View>
...
function Field({
  icon, placeholder, value, onChangeText, secure, rightSlot,
  autoCapitalize, borderColor,
}: {
...
const styles = StyleSheet.create({
  ...
  submitBtn: {
    marginHorizontal: 24, height: 54,
    backgroundColor: GREEN, borderRadius: 27,
